...
import { updateTreeConfig } from '@/common/interfaces/Tree.interface'
...
// 弹窗逻辑
const open = () => {
  ElMessageBox.confirm('确定要修改新的树木吗? 可能将自动更改树种相关信息', '提示', {
...
const updateTree = async () => {
  ...
  try {
    const res = await requestWithRetry(updateTreeConfig(props.treeID, form.value))
    // 重置表单
...
<template>
  ...
  >
    ...
    <el-button type="primary" @click="submitForm(ruleFormRef)">修改树木信息</el-button>
  </el-form>
</template>
